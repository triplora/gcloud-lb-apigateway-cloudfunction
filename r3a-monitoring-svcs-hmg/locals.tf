locals {
  ...
  target_logging_folder_bucket_name = "folder-bkt-er-${local.target_project_id}-global"
  sa_cloudlogs_id                   = "cloud-logs@system.gserviceaccount.com"
  sa_cloudlogs_email                = "cloud-logs@system.gserviceaccount.com"
  source_folder_id                  = "973902512869"
}
